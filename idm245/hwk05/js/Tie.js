gameObj.Tie = function (game) {};

gameObj.Tie.prototype = {
  create: function () {
    console.log("State - Tie");

    this.stage.backgroundColor = "#3b0000";
    ...
    var textScore = "Total Score: " + gameObj.gScore;
    ...
    var textScore = this.add.text(this.world.centerX, 520, textScore, generalStyle);
