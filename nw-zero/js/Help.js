...
gameObj.Help.prototype = {
  create: function () {
    ...
    var textHearts = "You have 3 hearts and 5 bullets.";
    var textDespawn = "Bullets despawn after 5 seconds.";
    ...
    var textHearts = this.add.text(this.world.centerX - 250, 368, textHearts, generalStyle);
    var textDespawn = this.add.text(this.world.centerX - 250, 428, textDespawn, generalStyle);
    var textKill = this.add.text(this.world.centerX - 250, 488, textKill, generalStyle);
    var textLoop = this.add.text(this.world.centerX - 250, 548, textLoop, generalStyle);

    var spHeartA = this.add.sprite(this.world.centerX - 50, 336, 'heartfull');
    spHeartA.anchor.setTo(0.5, 0.5);
    var spHeartB = this.add.sprite(this.world.centerX, 336, 'heartfull');
    spHeartB.anchor.setTo(0.5, 0.5);
    var spHeartC = this.add.sprite(this.world.centerX + 50, 336, 'heartfull');
    spHeartC.anchor.setTo(0.5, 0.5);
